...
## 5. allowed-address-pairs

```bash
PORT=a6dac663-cac4-4bf3-819d-46c8489ac774
# PORT=eb49fe7a-6c1c-408a-b264-87754cb6900e
IPS=173.16.0.0/24
openstack port set $PORT --allowed-address ip-address=$IPS
```
